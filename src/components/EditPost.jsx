        ...
        <div className="p-3 content text-center m-auto" style={{ width: "1000px" }}>
            ...
            <motion.div initial="hidden" animate="visible" variants={{
                ...
                <div className="form-group row pb-3 p-3">
                    ...
                    <input type="text" className="form-control" name="slug" defaultValue={post.slug} />
                </div>
                <div className="form-group row pb-3 p-3">
                    <label>Leírás</label>
                    <input type="text" className="form-control" name="description" defaultValue={post.description} />
                </div>
                <div className="form-group row pb-3 p-3">
