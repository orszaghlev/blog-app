            ...
            >
                <Box sx={style}>
                    ...
                    <Typography id="duplicate-post-modal-description" sx={{ mt: 2 }}>
                        <Button size={isTabletOrMobile ? "small" : "medium"} data-testid="duplicate-post-duplicate" variant="contained" color="secondary"
                            style={{ marginRight: "10px", backgroundColor: "#dc3545" }} onClick={handleDuplicatePost}>
                            Duplikálás
                        </Button>
